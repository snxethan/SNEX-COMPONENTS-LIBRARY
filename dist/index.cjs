      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-xl font-semibold mb-4", children: "Contact Me" }),
...
var ExternalLinkContext = (0, import_react2.createContext)(
  void 0
);
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "text-xl font-semibold text-white mb-2", children: "External Link Notice" }),
                  isProfessional ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-gray-300 text-sm mb-4", children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-gray-100 text-sm mb-4", children: [
                    "Please proceed with ",
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { children: "caution" }),
                    "."
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex justify-center gap-4", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                    "a",
                    {
                      href: targetUrl,
                      target: "_blank",
...
var useExternalLink = () => {
  const context = (0, import_react2.useContext)(ExternalLinkContext);
  if (!context) {
...
var PDFModalViewer = ({ pdfUrl, onClose }) => {
  ...
  const [isUnsupported, setIsUnsupported] = (0, import_react3.useState)(false);
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between p-3 sm:p-4 border-b border-[#333]", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.X, { size: 24 })
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex-1 overflow-auto relative bg-[#1a1a1a]", children: isUnsupported ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col items-center justify-center h-full text-white text-sm p-6 text-center space-y-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: "PDF preview is not supported on this device or browser." }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: "Please open the PDF in a new tab or download it to view." })
              ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
                isLoading && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute inset-0 flex items-center justify-center bg-[#1a1a1a] z-10", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.Loader2, { className: "h-8 w-8 animate-spin text-white" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "iframe",
                  {
                    src: pdfUrl,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("h1", { className: "text-3xl font-bold text-white mb-8 relative text-center", children: [
                "Security Policy",
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "absolute bottom-[-8px] left-0 w-full h-1 bg-gradient-to-r from-red-600 to-red-500" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "space-y-8", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "bg-[#1e1e1e] p-6 rounded-xl border border-[#333333] hover:border-red-600/50 transition-transform duration-300 ease-out hover:scale-[1.03] active:scale-95", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-3 mb-4", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_fa2.FaShieldAlt, { className: "text-red-500 text-xl" }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "bg-[#1e1e1e] p-6 rounded-xl border border-[#333333] hover:border-red-600/50 transition-transform duration-300 ease-out hover:scale-[1.03] active:scale-95", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-3 mb-4", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_fa2.FaUserShield, { className: "text-red-500 text-xl" }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { className: "text-xl font-semibold text-white", children: "Data Protection" })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "text-gray-300 space-y-2", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: "This website prioritizes your privacy and data protection:" }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("ul", { className: "list-disc list-inside space-y-1 ml-4", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "bg-[#1e1e1e] p-6 rounded-xl border border-[#333333] hover:border-red-600/50 transition-transform duration-300 ease-out hover:scale-[1.03] active:scale-95", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-3 mb-4", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_fa2.FaLink, { className: "text-red-500 text-xl" }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "bg-[#1e1e1e] p-6 rounded-xl border border-[#333333] hover:border-red-600/50 transition-transform duration-300 ease-out hover:scale-[1.03] active:scale-95", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-3 mb-4", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_fa2.FaCookie, { className: "text-red-500 text-xl" }),
        ...
        visible && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: isPdf ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex flex-col items-center", children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "text-xs text-white mb-1 font-medium", children: label }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "relative w-full h-[260px] bg-[#111] rounded overflow-hidden", children: [
                thumbnailLoading && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "absolute inset-0 flex items-center justify-center bg-[#111]", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react2.Loader2, { className: "h-6 w-6 animate-spin text-white/70" }) }),
                thumbnailError ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "absolute inset-0 flex items-center justify-center text-white/70 text-xs p-2 text-center", children: "Unable to generate preview" }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                  "embed",
                  {
                    src: url,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-2", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex items-center justify-between text-xs text-white", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "truncate max-w-[140px]", children: "PDF Document" }),
...
var Footer = () => {
  ...
  if (loading) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("footer", { className: "bg-[#121212] text-gray-400 w-full py-6 px-6", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "max-w-8xl mx-auto flex flex-col items-center gap-6", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "w-full flex flex-col lg:flex-row items-center justify-between gap-4 text-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "order-3 lg:order-1 mt-2 lg:mt-0", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "h-5 w-24 bg-[#333333] rounded animate-pulse" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "order-1 lg:order-2 flex items-center gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "w-8 h-8 rounded-full bg-[#333333] animate-pulse" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "h-5 w-40 bg-[#333333] rounded animate-pulse" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "order-2 lg:order-3", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "footer-links flex flex-col sm:flex-row items-center gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "h-5 w-16 bg-[#333333] rounded animate-pulse" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "h-5 w-24 bg-[#333333] rounded animate-pulse" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "hidden sm:block text-gray-600", children: "|" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "h-5 w-32 bg-[#333333] rounded animate-pulse" })
      ] }) })
    ] }) }) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("footer", { className: "bg-[#121212] text-gray-400 w-full py-6 px-6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "max-w-8xl mx-auto flex flex-col items-center gap-6", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "w-full flex flex-col lg:flex-row items-center justify-between gap-4 text-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "order-3 lg:order-1 mt-2 lg:mt-0", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToolTipWrapper_default, { label: "View Security Policy", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "button",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "order-1 lg:order-2 flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToolTipWrapper_default, { label: "Social Page", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("a", { href: "https://ethantownsend.dev", className: "text-sm text-gray-400 hover:text-red-600 transition-colors duration-200", children: [
          "Ethan Townsend \xA9 ",
          (/* @__PURE__ */ new Date()).getFullYear()
        ] }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "order-2 lg:order-3", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "footer-links flex flex-col sm:flex-row items-center gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToolTipWrapper_default, { label: "Portfolio", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_link.default, { href: "https://snex.dev", className: "hover:text-red-600 transition-colors duration-200", children: "snex.dev" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_link.default, { href: "https://snxethan.dev", className: "hover:text-red-600 transition-colors duration-200", children: "snxethan.dev" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "hidden sm:block text-gray-600", children: "|" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToolTipWrapper_default, { label: "Social Page", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_link.default, { href: "https://ethantownsend.dev", className: "hover:text-red-600 transition-colors duration-200", children: "ethantownsend.dev" }) })
      ] }) })
    ] }) }),
