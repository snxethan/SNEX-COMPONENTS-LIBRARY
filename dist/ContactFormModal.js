...
export default function ContactFormModal({ onClose }) {
    ...
    const modalContent = (_jsx("div", { 
        ...
        className: "fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm", onClick: close, children: _jsxs("div", { 
            ...
            onClick: (e) => e.stopPropagation(), children: [_jsx("button", { onClick: close, 
                    // It has a hover effect to make it more interactive.
                    className: "absolute top-1 right-3 text-3xl text-gray-400 hover:text-red-500", children: "\u00D7 " }), _jsx("h3", { className: "text-xl font-semibold mb-4", children: "Contact Me" }), _jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [" ", _jsx("input", { type: "text", required: true, placeholder: "Your Name", className: "w-full p-2 bg-[#2a2a2a] rounded border border-[#444]", value: name, onChange: (e) => setName(e.target.value) }), _jsx("input", { type: "email", required: true, placeholder: "Your Email", className: "w-full p-2 bg-[#2a2a2a] rounded border border-[#444]", value: email, onChange: (e) => setEmail(e.target.value) }), _jsx("textarea", { required: true, placeholder: "Your Message", className: "w-full p-2 bg-[#2a2a2a] rounded border border-[#444] h-32", value: message, onChange: (e) => setMessage(e.target.value) }), _jsx("button", { type: "submit", className: "w-full py-2 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 rounded", children: "Send Message" })] })] }) }));
